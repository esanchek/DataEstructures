...
-- e.g. isDiagonalPixel (fromList [2,2]) == True
----------------------------------------------------------------
...
-- e.g. prop_diagonal_pixel (fromList [1,1]) == True
--      prop_diagonal_pixel (fromList [1,2]) == False
----------------------------------------------------------------

prop_diagonal_pixel :: Pix -> Bool
prop_diagonal_pixel p = transpose p == p
...
prop_idempotens p = (transpose.transpose) p == p
...
-- e.g. isDiagonal (Maxel.fromLists [2,2]) == True
----------------------------------------------------------------

isDiagonalMaxel :: Pix -> Bool
isDiagonalMaxel p = row p == col p
